...
class RightConfigScreen extends Screen {
    ...
    public void render(GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        graphics.drawCenteredString(this.font, "===[ НАСТРОЙКА ПРАВОЙ РУКИ (K) ]===", this.width / 2, cy - 100, 0xFF5555);
        ...
        drawCustomButton(graphics, "Размер (П): -" + RightHandConfig.rightScalePercent + "%", cx, cy + 52, 120, 18, mouseX, mouseY);
        ...
        drawCustomButton(graphics, "Удар (П): " + animName, cx, cy + 74, 120, 18, mouseX, mouseY);
